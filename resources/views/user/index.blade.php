...
@section('content')
    <div class="main-content fl-right">
            ...
            <div class="section-detail">
                <ul class="list-item">
                    @foreach ($products as $item)
                        <li>
                            <a href="{{ $item->category && $item->category->catProductParent ? route('product.detail', ['slugCategory' => $item->category->catProductParent->slug, 'slugProduct' => $item->slug])  : null }}"
                                title="" class="thumb">
        ...
        <div class="section" id="list-product-wp">
            <div class="section-head">
                <a href="{{ route('user.category', ['slugCategory' => 'tui-xach']) }}" class="section-title">Túi xách</a>
            </div>
            <div class="section-detail">
                @foreach ($productIphone->chunk(4) as $chunkProductIphone)
                    <ul class="list-item clearfix">
                        @foreach ($chunkProductIphone as $item)
                            <li>
        ...
        <div class="section" id="list-product-wp">
            <div class="section-head">
                <a href="{{ route('user.category', ['slugCategory' => 'giay-dep']) }}" class="section-title">Giày dép</a>
            </div>
            <div class="section-detail">
                @foreach ($productLaptop->chunk(4) as $chunkProductLaptop)
                    <ul class="list-item clearfix">
                        @foreach ($chunkProductLaptop as $item)
